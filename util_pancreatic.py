...
def concat_express_and_label_and_gcn_data(file_name = 'ssr1'):
    source_gene_express = pd.read_csv('../data/human_mouse/human_merge.csv', index_col=0)
    target_gene_express = pd.read_csv('../data/human_mouse/mouse_merge.csv', index_col=0)
    gene_gcn = pd.read_csv('../data/net/gene_gcn_feas.csv')
    src_label = pd.read_csv('../data/human_mouse/human_cell.csv')
    tar_label = pd.read_csv('../data/human_mouse/mouse_cell.csv')
